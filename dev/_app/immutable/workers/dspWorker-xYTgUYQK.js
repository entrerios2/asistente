(function() {
	...
	function tI(C, I, A) {
		...
		for (let h = 0; h < V; h++) r = LA[h], h < r && (e = C[h], C[h] = C[r], C[r] = e, e = I[h], I[h] = I[r], I[r] = e);
		for (let h = 1; h < V; h <<= 1) {
			Q = 0, i = V / (h << 1);
			for (let s = 0; s < h; s++) {
				t = lA[Q + c], o = A * lA[Q];
	...
	function wg() {
		typeof Uint32Array < "u" ? LA = new Uint32Array(V) : LA = [], typeof Float64Array < "u" ? lA = new Float64Array(V * 1.25) : lA = [];
	}
	function fg() {
		let C = 0, I = 0, A = 0;
		for (LA[0] = 0; ++C < V;) {
	...
	var V, LA, lA, dI, Fg = iA((() => {
		V = 0, LA = null, lA = null, dI = {
			init: sg,
			fft1d: ZA,
			ifft1d: OA,
			fft2d: hg,
	...
	async function Hg(C) {
		try {
			...
			qA = new I(C), await qA.profile(), uI = C;
		} catch (I) {
			console.warn("[dspWorker] WebFFT not available, using Radix-2 fallback:", I), qA = null;
		}
	}
